...
tm_end <- as.POSIXct("2025-05-29 00:00:00", tz = "UTC")

nam_1 <- study_level_wf(
...
### 2nd window: 2 days later AND one new bird

tm_end <- as.POSIXct("2025-05-31 00:00:00", tz = "UTC")

nam_2 <- study_level_wf(
  apps_paths = apps_paths,
  mvbk_usr = mvbk_creds$scavengersonpatrol$usr, 
  mvbk_pwd = mvbk_creds$scavengersonpatrol$pwd,
  study_name = "AVulture Namibia SOP", 
  animal_ids = c("GA_6581", "GA_5404", "TO_6485", "GA_6594"), 
